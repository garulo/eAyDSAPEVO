                                ...
                                <table  class="table table-sm table-responsive table-striped" id="tabla_servicios1">
                                    <tbody>
                                        <tr class="encabezado" id="servico_encabezado">
                                            <th style="text-align: center" align="center" width="5%">Eliminar</th>
                                            <th style="text-align: center" align="center" width="10%"><b>Contrato</b></th>
                                            <th align="center" width="7%"><b>Consultar Recibo</b></th>
                                            <th style="text-align: center" align="center" width="70%"><b>Dirección</b></th>
                                            <th style="text-align: center" align="center" width="18%"><b>Fecha de Vencimiento</b></th>
                                            <th style="text-align: center" align="center" width="5%"><b>Importe</b></th>
                                    ...
                                    <script>
                                        ...
                                        function eliminarServicio(p1) {
                                            ...
                                            swal({
                                                title: "¿Desea eliminar el contrato " + p1 + "?",
...
//                                            System.out.println("fact ::" + fact.getString("TO_CHAR").toString());
            ...
            <div>
                ...
                <form name="pagarServForm" method="POST" action="pagarserviciosEVO">
