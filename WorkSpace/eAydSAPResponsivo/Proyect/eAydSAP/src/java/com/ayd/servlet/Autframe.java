...
import static com.ayd.servlet.Autenticacion.sha256;
...
public class Autframe extends HttpServlet {
   ...
   public static String sha256(String base) {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       System.out.println("LoginSwitchFrame::: " + sg.getDetenerLogin());
        if (sg.getDetenerLogin().equalsIgnoreCase("false")) {
                  ...
                  //System.out.println("json ::: " + json);
                    ...
                    if ("null" != jsonObj.get("Response").toString()) {
                        ...
                        String tokenlogin = jsonObjloginresponsedata.get("Token").toString();
                            ...
                            System.out.println("success LOGIN FRAME TRUE::::: "+tokenlogin+" / " + email+" / "+password+" / "+d);
                            ...
                            System.out.println("success LOGIN FRAME REDIRECT NEW TAB TRUE:::::");
                        out.println("<script type=\"text/javascript\">");
                        out.println("window.parent.location.href='https://web.sadm.gob.mx';");                                   
                        out.println("window.open('"+INICIO+"','_blank');");
                        out.println("</script>");
                   
                    } else {
                        System.out.println("success LOGIN FALSE:::::");
                        out.println("<script type=\"text/javascript\">");
                        out.println("window.parent.location.href='sweetAlertFrameError.html'");
                        out.println("</script>");
                    }}else{
                    System.out.println("success LOGIN FALSE:::::");
                        out.println("<script type=\"text/javascript\">");
            ...
            System.out.println("success LOGIN FALSE:::::");
            out.println("<script type=\"text/javascript\">");
            out.println("window.parent.location.href='sweetAlertAutFrameSwitch.html'");
            out.println("</script>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
           ...
           Logger.getLogger(Autframe.class.getName()).log(Level.SEVERE, null, ex);
       }
    }
